      ...
      {cart.length > 0 ? (
        <>
          ...
          <div className="flex items-center justify-between px-4 my-8">
            ...
            <Link
              to="/checkout"
              className="bg-lightred hover:bg-red-600 text-white px-4 py-2 rounded-lg font-semibold"
            >
              Checkout
            </Link>
          </div>
        ...
        <div className="text-center flex flex-col gap-4 items-center justify-center min-h-[80vh] py-4 border border-black">
          ...
          <Link
            to="/shop"
            className="bg-lightred hover:bg-red-600 text-white px-4 py-2 rounded-lg font-semibold w-max"
          >
            Shop Now
          </Link>
        </div>
