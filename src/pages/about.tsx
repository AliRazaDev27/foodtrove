    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 gap-8 my-12'>
        <div className='flex flex-col justify-between'>
            ...
            <div className='flex flex-col gap-2'>
                <p className='text-secondary'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ratione, recusandae
...
rerum quod. Tempora magni autem a voluptatibus neque.</p>
                <p className='text-secondary'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut vitae rerum cum
accusamus magni consequuntur architecto, ipsum deleniti expedita doloribus
suscipit voluptatum eius perferendis amet!.</p>
                <p className='text-secondary'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, maxime amet
...
<div>
    <p className='text-4xl font-semibold text-lightred'>0.1<span className='text-lg text-neutral-600 '>k</span></p>
    <p>Vendors</p>
</div>
<div>
    <p className='text-4xl font-semibold text-lightred'>23<span className='text-lg text-neutral-600 '>k</span></p>
    <p>Customers</p>
</div>
<div>
    <p className='text-4xl font-semibold text-lightred'>2<span className='text-lg text-neutral-600 '>k</span></p>
    <p>Products</p>
</div>
            </div>
        ...
        <div className='w-full'>
            <img src="/about.png" alt="about" className='bg-cover' />
        </div>
