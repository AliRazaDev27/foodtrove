 ...
 useGSAP(() => {
    gsap.to("#textDiv", {
      text: {
        ...
        newClass: "text-4xl md:text-5xl md:leading-[60px] font-extrabold",
      },
      duration: 2,
      delay:0.5,
      ease: "power1.in",
    ...
    return(
        <div className="relative flex flex-col-reverse leading md:flex-row  justify-evenly min-h-[90vh] items-center bg-gray-300">
                <div className="flex flex-col gap-4 py-2 px-2  md:w-1/2">
                    ...
                    <IoPaperPlaneOutline className="hidden md:block text-gray-700   translate-x-2" />
                        ...
                        <BackgroundSlider background="bg-lightred" color="bg-lightgreen" rounded="rounded-e-full"><button className="px-4 py-4 text-white">Subscribe</button></BackgroundSlider>
