...
export function SubscribeCard(){
    return(
        <div className="flex  items-center justify-between border bg-cyan-100 my-16 py-4 px-4">
...
<button className="hidden md:block bg-lightred text-white px-8 py-4 rounded-full">Subscribe</button>
